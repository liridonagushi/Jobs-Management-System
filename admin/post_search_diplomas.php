...
if(!empty($_SESSION[$filename]['title'])){
  $_SESSION[$filename]['search_txt'] = ' AND (diploma_types.type_diploma LIKE "%'.$_SESSION[$filename]['title'].'%")';
  }else{
  $_SESSION[$filename]['search_txt']='';
};
...
// Later to put in session value and the screen
  ...
  $_SESSION[$filename]['search_query']=$_SESSION[$filename]['search_txt'];

// End Sorting
// // Redirection of the page
header('Location: lst_diploma_types.php');
?>