...
<div class="container">
 ...
 <div class="row">
        ...
        <form  id="form-validation" action="post_login.php" method="post">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <a class="fancybox1 fancybox.iframe" href="forgot_pass.php"><span class="text-error">Forgot Password ?</span></a>
            </div>
          </div>
        </form>
    </div>
    ...
    <div class="col-md-6 difbg2">
      <div class="fadeIn wow animated margin-bottom">
        <h2 style="color:white">Register Employer !</h2>
      ...
      <div class="row">
        <div class="col-sm-12">
          <input type="submit" class="form-control btn btn-default" value="Agree &  Register">
        </div>
      </div>
      </form>
      </div>
