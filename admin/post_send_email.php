...
$error_txt = check_error(check_string_length($_POST['employee_email'], 2, 50));
...
$stmt->bindValue(':id_from', $_SESSION['jbms_back']['id_user']);
...
if ($_POST['target']=='messages'){
    ...
    header('Location: view_messages.php?id_user='.$_POST['id_employee'].'#module');
