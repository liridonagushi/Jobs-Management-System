  ...
  <div class="container-custom-grid">
   <div class="row">
    ...
    <?php } } }else{ ?>
      ...
      <div class="row">
        <div class="form-group col-md-12 border text-center margintop50px">
    ...
    <div class="pagination">
       <?php echo paginate('lst_inbox.php', '?p=', $nbPages, $current); ?>
    </div>
